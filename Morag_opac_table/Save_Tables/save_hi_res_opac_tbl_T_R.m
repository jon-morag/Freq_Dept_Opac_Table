...
tic
% profile on
[ kappa_abs,kappa_es,nu_calc ] = produce_high_res_opac_tbl_R_T( 1 , N_nu , low_res_spacing, tbl_R , tbl_T,include_ff ,include_bf ,include_bb, Z_metal); %Z_metal=[]->do nothing
